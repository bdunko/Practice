...
public class DeleteMiddle {
	...
	public static <T> void deleteMiddle(BLinkedNode<T> head, BLinkedNode<T> toDelete) {
	...
	//Time: O(1)	Space: O(1)
	public static <T> void deleteMiddleGivenMiddle(BLinkedNode<T> middle) {
	...
	public static void main(String[] args) {
		...
		BLinkedNode<Integer> list = BLinkedNode.createList(List.of(1, 2, 3, 4, 5, 6, 7, 8));
		deleteMiddle(list, list.next.next.next); //delete 4
		Test.assertion(BLinkedNode.listEquals(list, BLinkedNode.createList(List.of(1, 2, 3, 5, 6, 7, 8))));
		deleteMiddle(list, list.next); //delete 2
		Test.assertion(BLinkedNode.listEquals(list, BLinkedNode.createList(List.of(1, 3, 5, 6, 7, 8))));
		deleteMiddle(list, list.next.next.next.next); //delete 7
		Test.assertion(BLinkedNode.listEquals(list, BLinkedNode.createList(List.of(1, 3, 5, 6, 8))));
		...
		Test.assertion(BLinkedNode.listEquals(list, BLinkedNode.createList(List.of(1, 3, 5, 6, 8))));
		deleteMiddle(list, new BLinkedNode<Integer>(1000)); //try delete element not in list (nothing happens)
		Test.assertion(BLinkedNode.listEquals(list, BLinkedNode.createList(List.of(1, 3, 5, 6, 8))));
		
		Test.header("deleteMiddleGivenMiddle");
		list = BLinkedNode.createList(List.of(1, 2, 3, 4, 5, 6, 7, 8));
